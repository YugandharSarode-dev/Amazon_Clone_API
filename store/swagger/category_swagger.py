...
response_post = {'message': ['Category created'], 'code': 201, 'success': True, 'data': {}}
response_update = {'message': ['Category updated'], 'code': 200, 'success': True, 'data': {}}
response_delete = {'message': ['Category deleted'], 'code': 200, 'success': True, 'data': {}}
...
response_not_found = {'message': ['Category not found'], 'code': 404, 'success': True, 'data': {}}
...
swagger_auto_schema_list = swagger_auto_schema(
    ...
    operation_id='list category',
    operation_description='API to list categories'
)
...
swagger_auto_schema_post = swagger_auto_schema(
    ...
    operation_description='API to create new category'
)
...
swagger_auto_schema_update = swagger_auto_schema(
    ...
    operation_description='API to update category'
)
...
swagger_auto_schema_delete = swagger_auto_schema(
    ...
    operation_description='API to delete single category'
)

swagger_auto_schema_bulk_delete = swagger_auto_schema(
    responses={'200': json.dumps(response_delete),'403': json.dumps(response_unauthenticate),'401': json.dumps(response_unauthorized),'404': json.dumps(response_not_found)},
    operation_id='bulk delete category',
    operation_description='API to delete multiple categories'
)
