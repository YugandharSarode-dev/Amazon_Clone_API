...
class OrderTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.get_instance, created = cls.model_class.objects.get_or_create(id=1, user=cls.user, total_price=100)

    url = BASE_URL + 'order/'
    data = dict()

    def test_add_api_valid(self):
        self.data['products'] = [self.product.id]
        self.data['total_price'] = 100
